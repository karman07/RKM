...
import {
  ...
  getGoldBalance, previewGoldRedemption, getCashiers,
...
function ApproveSaleModal({ items, onClose, onApproved, onRejected }: ApproveSaleModalProps) {
  ...
  // Computed prices — an investment plan's redemption option (once chosen) replaces the base
  // amount with its GST-recomputed payable figure; the advance scheme (unchanged) then
  // subtracts from that as before, using the best single waiver % rather than stacking.
