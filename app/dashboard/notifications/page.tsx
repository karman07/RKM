...
const TYPE_CONFIG: Record<string, { label: string; bg: string; border: string; path: string }> = {
  sale_enquiry:     { label: 'Enquiry',    bg: 'bg-blue-50',    border: 'border-blue-200',    path: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
  enquiry_approved: { label: 'Approved',   bg: 'bg-emerald-50', border: 'border-emerald-200', path: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z' },
  enquiry_rejected: { label: 'Rejected',   bg: 'bg-red-50',     border: 'border-red-200',     path: 'M6 18L18 6M6 6l12 12' },
  commission_paid:  { label: 'Commission', bg: 'bg-[#5A0F1A]/5', border: 'border-[#5A0F1A]/20', path: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
...
const STROKE: Record<string, string> = {
  sale_enquiry: '#3b82f6', enquiry_approved: '#10b981', enquiry_rejected: '#ef4444', commission_paid: '#5A0F1A', default: '#94a3b8',
};
    ...
    <div className="p-6 md:p-10 space-y-8 pb-20 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
        {[
          ...
          { key: 'sale_enquiry',     label: 'Enquiries',  count: typeCounts.sale_enquiry || 0,       color: 'text-blue-600',    border: 'border-blue-600' },
          { key: 'enquiry_approved',label: 'Approved',   count: typeCounts.enquiry_approved || 0,   color: 'text-emerald-600', border: 'border-emerald-600' },
          { key: 'enquiry_rejected',label: 'Rejected',   count: typeCounts.enquiry_rejected || 0,   color: 'text-red-600',     border: 'border-red-600' },
          { key: 'commission_paid', label: 'Commission', count: typeCounts.commission_paid || 0,    color: 'text-[#5A0F1A]',   border: 'border-[#5A0F1A]' },
        ].map(s => {
