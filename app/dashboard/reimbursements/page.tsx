...
const CATEGORY_CONFIG: Record<string, { label: string; color: string; iconPath: string }> = {
  ...
  food:        { label: 'Food',        color: 'bg-orange-50 text-orange-700 border-orange-100', iconPath: 'M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4' },
  supplies:    { label: 'Supplies',    color: 'bg-purple-50 text-purple-700 border-purple-100', iconPath: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4' },
