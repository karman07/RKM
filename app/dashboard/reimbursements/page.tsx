          ...
          {reimbursements.length === 0 ? (
            ...
            <div className="divide-y divide-slate-50">
              {reimbursements.map(item => {
                ...
                return (
                  <div key={item._id} className="px-8 py-5 hover:bg-slate-50/50 transition-colors">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                      <div className="flex items-center gap-4">
                        <div className="w-10 h-10 rounded-2xl bg-slate-100 flex items-center justify-center flex-shrink-0">
                          <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="#64748b" strokeWidth={1.8}>
                            <path strokeLinecap="round" strokeLinejoin="round" d={cat?.icon || 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z'} />
                          </svg>
                        </div>
                        <div>
                      ...
                      <div className="flex flex-col items-end gap-2 flex-shrink-0">
                        ...
                        {item.admin_note && (
                          <p className="text-[10px] text-slate-400 italic max-w-[200px] text-right">Note: {item.admin_note}</p>
                        )}
                      </div>
                    </div>
                  </div>
