...
function StatCard({ label, value, total, color, bg, barColor }: StatCardProps) {
...
export default function MyAttendancePage() {
  ...
  // Build holiday map for the viewed month
          ...
          {Array.from({ length: totalDays }).map((_, idx) => {
            ...
            return (
              <div
                ...
                className={`relative aspect-square flex flex-col items-center justify-center rounded-xl transition-all cursor-default
