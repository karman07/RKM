      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <button type="button" onClick={() => onChoose('cash_benefit')}
          ...
          <div className="flex items-center justify-between mb-2">
            ...
            {choice === 'cash_benefit' && <span className="text-amber-600"><CheckIcon /></span>}
          </div>
        ...
        <button type="button" onClick={() => onChoose('making_charge_waiver')}
          ...
          <div className="flex items-center justify-between mb-2">
            ...
            {choice === 'making_charge_waiver' && <span className="text-amber-600"><CheckIcon /></span>}
          </div>
          <div className="space-y-1 text-[11px]">
            <div className="flex justify-between"><span className="text-slate-400">Investment Amount Used</span><span className="font-bold">₹{fmt(makingChargeWaiverOption.investmentAmountUsed)}</span></div>
            ...
            <div className="flex justify-between"><span className="text-slate-400">Eligible Gold for Waiver</span><span className="font-bold">{(makingChargeWaiverOption.eligibleGoldGramsUsed || 0).toFixed(2)}g of {(makingChargeWaiverOption.jewelryGoldWeightGrams || 0).toFixed(2)}g</span></div>
            ...
            <div className="flex justify-between"><span className="text-slate-400">Waived Making Charges</span><span className="font-bold text-amber-700">− ₹{fmt(makingChargeWaiverOption.waivedMakingCharges || 0)}</span></div>
