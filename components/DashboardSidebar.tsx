...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    sub: [
      { label: 'Raise Enquiry', href: '/dashboard/enquiries?new=1' },
    ],
  },
  {
    ...
    <aside className="flex flex-col h-full w-64 bg-[#5A0F1A] text-white">
      ...
      <div className="flex items-center gap-3 px-4 py-5 border-b border-white/10">
        ...
        <div className="min-w-0">
          <p className="text-sm font-black leading-none">RKM Sales</p>
      ...
      <div className="border-t border-white/10 p-3">
        <div className="flex items-center gap-2.5">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[10px] text-white/50 font-medium">Sales Agent</p>
          </div>
          <button
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <div className="md:hidden flex items-center gap-3 px-4 py-3 bg-white border-b border-slate-100 shadow-sm">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[10px] text-[#7A1C2A] font-bold uppercase tracking-wider truncate">Field Sales</p>
          </div>
